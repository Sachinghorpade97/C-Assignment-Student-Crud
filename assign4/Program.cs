...
void Test1()
{
    ...
    student.addStudentRecord(new StudentInfo("sachin", 21, DateTime.Now, Gender.Male));
    student.addStudentRecord(new StudentInfo("sachin", 25, DateTime.Now, Gender.Male));
